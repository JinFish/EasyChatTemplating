...
def convert_userprompt_transformers(tokenizer:PreTrainedTokenizer, user_prompt):
    """
    ...
    """
    content = tokenizer.apply_chat_template([{"role": "user", "content":user_prompt}], tokenize=False)
    return content
